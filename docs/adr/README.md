...
| [ADR-W30](ADR-W30-deepseek-flash.md) | 固定 DeepSeek V4 Flash 文本 Provider、专用 DPAPI 密钥与脱敏视觉摘要出口 | 已按所有者指令采用；核心 `cd5cd43` 已在 Draft PR #35，本地自动化/质量门通过，最终 head CI 与真实 Key 验证仍待形成证据 |
